...
2. Open: https://github.com/dicko2563repos/study-spark/blob/main/dist/StudySpark-0.3.4-debug.apk
...
```bash
adb install -r StudySpark-0.3.4-debug.apk
```
...
- **Test my knowledge:** optional 10-question probe with a session recap; Progress can show shaky tags after you answer
